...
export const WORLDS: WorldTheme[] = [
  {
    ...
    bgImage: require('../../assets/gameassets/boba-bg-1.png'),
  ...
  },
  {
    ...
    bgImage: require('../../assets/gameassets/boba-bg-2.png'),
  ...
  },
  {
    ...
    bgImage: require('../../assets/gameassets/boba-bg-3.png'),
  ...
  },
  {
    ...
    bgImage: require('../../assets/gameassets/boba-bg-4.png'),
